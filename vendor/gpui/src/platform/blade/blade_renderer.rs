        ...
        for batch in scene.batches() {
            match batch {
                ...
                PrimitiveBatch::BackdropBlurs(_) => {
                    // Component backdrop sampling is currently implemented by
                    // the DirectX renderer. Blade keeps the primitive in the
                    // same scene and relies on the translucent tint fallback
                    // emitted by the theme layer.
                }
