...
impl Window {
    ...
    /// Paint a component-level backdrop material into the scene.
    ///
    /// On the DirectX backend this snapshots the pixels already rendered below
    /// the bounds, performs a separable blur in the pixel shader, applies a
    /// normal-driven UV displacement for refraction, and adds a Fresnel edge
    /// reflection. Other backends keep the primitive in the scene and use a
    /// translucent tint fallback when the platform renderer has no backdrop
    /// sampling support.
    pub fn paint_backdrop_blur(&mut self, backdrop: PaintBackdropBlur) {
        ...
        self.next_frame.scene.insert_primitive(BackdropBlur {
            ...
            blur_radius: backdrop.blur_radius.0 * scale_factor,
            distortion_strength: backdrop.distortion_strength * scale_factor,
...
/// Parameters for a component-level backdrop material.
#[derive(Clone, Copy, Debug)]
pub struct PaintBackdropBlur {
    /// The bounds of the material within the window.
    pub bounds: Bounds<Pixels>,
    /// The radii of the material's corners.
    pub corner_radii: Corners<Pixels>,
    /// Gaussian blur radius in logical pixels.
    pub blur_radius: Pixels,
    /// Maximum UV displacement in logical pixels.
    pub distortion_strength: f32,
    /// Strength of the Fresnel reflection term.
    pub reflection_strength: f32,
    /// Index of refraction used to derive the surface normal response.
...
impl Default for PaintBackdropBlur {
    fn default() -> Self {
        Self {
            bounds: Bounds::default(),
            corner_radii: Corners::default(),
            blur_radius: px(18.),
            distortion_strength: 3.8,
            reflection_strength: 0.62,
            refraction_index: 1.52,
            noise_scale: 0.018,
            thickness: px(22.),
            normal_strength: 1.45,
            displacement_scale: 1.28,
            height_transition_width: px(18.),
            height_blur_factor: 0.9,
            chromatic_aberration: 1.8,
            dispersion_r: 1.0,
            dispersion_b: 1.0,
            brightness: 1.08,
            vibrancy: 1.18,
            specular_strength: 1.62,
            shininess: 88.0,
            rim_strength: 1.62,
            highlight_width: px(6.),
            caustic_intensity: 0.38,
            liquid_dome: 0.94,
            ...
            parallax_scale: 1.25,
            backdrop_pinch: 0.96,
            lens_refraction_px: 12.0,
            lens_depth_effect: 0.12,
            press_progress: 0.0,
            glow_center: [0.5, 0.5],
            glow_strength: 0.0,
