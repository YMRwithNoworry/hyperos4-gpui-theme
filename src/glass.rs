    ...
    pub fn from_theme(theme: &Theme) -> Self {
        ...
        Self {
            ...
            fill_hover: theme
                ...
                .alpha(0.9),
            border: theme.border.blend(theme.primary.opacity(0.42)).alpha(0.86),
            highlight: theme
                .primary_foreground
                .alpha(if theme.is_dark() { 0.34 } else { 0.74 }),
            shadow: theme
                .foreground
            ...
            chromatic_aberration: if theme.is_dark() { 2.2 } else { 1.8 },
            dispersion_r: 1.0,
            dispersion_b: 1.18,
            brightness: 1.08,
            vibrancy: 1.22,
